...
public class AdminView1 {
	...
	private void initialize() {
		...
		frame.setBounds(100, 100, 831, 615);
		...
		lblNewLabel_2.setBounds(12, 13, 176, 152);
		View_Bills.add(lblNewLabel_2);
		
		JButton btnViewpayment = new JButton("ViewPayment");
		...
		btnViewpayment.setBounds(22, 178, 152, 36);
